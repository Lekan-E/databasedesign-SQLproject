...
SELECT club_shirt, season, total_shots, CONCAT(ROUND((shots_on_target/total_shots)*100,1),'%') as shot_on_target, 
goals_shot, shots_90, attempted_takeon, CONCAT(ROUND((successful_takeon/attempted_takeon)*100,1),'%') as successful_takeon
FROM shooting;

/*2022-2023*/
/*CREATE TEMPORARY TABLE attacking_22_23*/
SELECT club_shirt, season, total_shots, CONCAT(ROUND((shots_on_target/total_shots)*100,1),'%') as shot_on_target, 
goals_shot, shots_90, attempted_takeon, CONCAT(ROUND((successful_takeon/attempted_takeon)*100,1),'%') as successful_takeon
FROM shooting
...
/*2021-2022*/
/*CREATE TEMPORARY TABLE attacking_21_22*/
SELECT club_shirt, season, total_shots, CONCAT(ROUND((shots_on_target/total_shots)*100,1),'%') as shot_on_target, 
goals_shot, shots_90, attempted_takeon, CONCAT(ROUND((successful_takeon/attempted_takeon)*100,1),'%') as successful_takeon
FROM shooting
...
SELECT 
fi.last_name, (s2.total_shots - s1.total_shots) as difference_shots,
